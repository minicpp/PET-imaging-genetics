...
set(gca,'XTickLabel',{'GG','TG','TT'})
%legend('\mu(Pos-cingulate) offset','\mu(Pos-precuneus) offset','\mu(GlobalCortex) offset')
legend('Pos-cingulate','Pos-precuneus','Global-cortex','Location', 'northwest')
%ylabel('SUVR([18F]AV45) sample mean on ROIs')
ylabel('SUVR([18F]AV45) mean')
xlabel('SNP genotyping on rs1501228')
set(h(1),'FaceColor','y');
